...
VALUES ('Nike Dunk Low Triple Pink', 'These are the barbie inspired nike dunks. Dance the Night Away!', 150.00, 100, 'static/images/dunks.jpeg', 'Shoes');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Nike Air Cross Trainer 3', 'Flex your sneaker style with these retro orange kicks. ', 220.00, 100, 'static/images/NikeAir.jpeg', 'Shoes');

INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Air Jordan 1', 'Still stuck in Asttroworld? Get these Mochas to upgrade to Utopia.', 500.00, 100, 'static/images/Air Jordan 1 .jpeg', 'Shoes');
