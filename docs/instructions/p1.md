...
| 1.1 | 07/17/23 | Jack E's revisions| [Jack Eliseo](mailto:jeliseo@uncc.edu) | [Jack Eliseo](mailto:jeliseo@uncc.edu) |
...
Jack Eliseo-Constraints:
	Constraint 1: Time wise for this project is small typically with what students are usually provided. This is a full summer term class meaning that it covers the UNCC summer term 1 and summer term 2. While there is a good amount of time given to students there is not the same as compared to the fall and spring semesters. 
	Constraint 2: Meeting our requirements. With the provided time there may be some small bugs or errors that may be unseen by our professional team. In these instances where proper testing has taken place and these issues still persist, our requirements for ourselves will have not been met. 
